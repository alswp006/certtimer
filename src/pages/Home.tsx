 ...
 *   CertTimer -> the app's display name
 *   자격증 시험 D-day·학습 진도 트래커 — 매일 체크인하면 배너 광고, 합격 예측 리포트는 리워드 광고 후 공개    -> the one-line description
 */
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <SummaryHero
        label="CertTimer"
        value={<Paragraph.Text typography="t2">자격증 시험 D-day·학습 진도 트래커 — 매일 체크인하면 배너 광고, 합격 예측 리포트는 리워드 광고 후 공개</Paragraph.Text>}
