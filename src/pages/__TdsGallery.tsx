  ...
  return (
    <>
      ...
      <Section title="TextField (variants)">
        <TextField variant="box" label="Box" placeholder="Box input" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="line" label="Line" placeholder="Line input" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="big" label="Big" placeholder="Big input" value={text} onChange={(e) => setText(e.target.value)} />
      </Section>
